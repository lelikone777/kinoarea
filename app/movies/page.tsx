...
export default function MoviesPage() {
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-50">
      ...
      <main className="relative z-10 mx-auto max-w-6xl px-5 pb-24 pt-10 space-y-6">
      ...
      <form
        ...
        className="grid gap-3 rounded-2xl border border-white/10 bg-slate-900/60 p-4 sm:grid-cols-4"
      >
        <input
          value={query}
